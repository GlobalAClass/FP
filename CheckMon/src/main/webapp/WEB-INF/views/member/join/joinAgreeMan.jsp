...
<script>
function checkAgree(){
	if(!document.all.agree1.checked){
		alert('모든 항목에 동의 후 회원가입을 진행해주세요.');
	}else{
		location.href="goManJoin.do"
	}
}
</script>
<body>
<div class="container">
    	<div class="card">
    	<h1 class="card-header" align="center">관리자 회원가입</h1>
		<table class="table">
			<tr>
				<td align="center" style="font-size:20px; font-weight:bold;">개인 정보 처리 방침</td>
			</tr>
			<tr>
				<td align="center">
					<textarea style="width:100%;height:300px;resize: none;" disabled>
'CheckMon'은 (이하 '회사'는) 고객님의 개인정보를 중요시하며, "정보통신망 이용촉진 및 정보보호"에 관한 법률을 준수하고 있습니다.
...
ο 수집항목 : 이름 , 이메일 , 비밀번호 , 휴대전화번호 , 이메일 , 사업자 등록번호 , 매장 이름, 매장 주소, 매장 위도, 매장 경도, 서비스 이용기록 , 접속 로그 , 접속 IP 정보
...
ο 서비스 제공에 관한 매장 정보를 통한 출퇴근 기록 관리
ο 회원 관리
회원제 서비스 이용에 따른 본인확인 , 개인 식별 , 연령확인 , 접속 빈도 파악 또는 회원의 서비스 이용에 대한 통계
...
4.경찰청 사이버테러대응센터 (www.ctrc.go.kr/02-392-0330)
			...
			<tr>
				...
				<label class="checkbox-inline">
					위 항목을 읽고 동의합니다 <input type="checkbox" value="agree1" id="agree1">
				</label>
				</td>
			</tr>
			<tr>
				<td align="center">
					<input type="button" class="btn btn-success" value="동의 후 회원가입" onclick="checkAgree()">
